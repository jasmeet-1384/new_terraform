...
sudo echo '<!DOCTYPE html> <html> <body style="background-color:rgb(250, 210, 210);"> <h1>Welcome to mysite App2</h1> <p>Terraform Learning</p> <p>ALB</p> </body></html>' | sudo tee /var/www/html/app2/index.html
